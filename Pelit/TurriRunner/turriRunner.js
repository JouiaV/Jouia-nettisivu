...
import { setupTurricoinObject, updateTurricoinObject } from "./turricoin.js"
...
function update(time) {
    ...
    updateTurricoinObject(delta, speedScale, getTurriRect())
...
function handleStart() {
    ...
    setupGround()
    setupTurri()
    setupEste(speedScale)
    setupTurricoinObject(speedScale)
